...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			$(document.body).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='fonts-size:"+tdw+";visibility:hidden;' ></div>");
	...
	filterToolbar : function(p){
		...
		return this.each(function(){
			...
			buildRuleMenu = function( elem, left, top ){
				...
				var str = '<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="fonts-size:'+fs+';left:'+left+'px;top:'+top+'px;">',
	...
	navGrid : function (elem, o, pEdit,pAdd,pDel,pSearch, pView) {
		...
		return this.each(function() {
			...
			for(i = 0; i<clone; i++) {
				...
				tdw = $(".ui-jqgrid").css("font-size") || "11px";
				$('body').append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='fonts-size:"+tdw+";visibility:hidden;' ></div>");
